...
def register_new_two_segment_env(id: str, cart_params: CartParams, time_limit: float = 10.0):
    _register[id] = EnvRegisterValue(id, load_physics_wrapper(cart_params), SegmentTask, time_limit)
