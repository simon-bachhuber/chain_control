...
setuptools.setup(
    name="chain_control", packages=setuptools.find_packages(), version="0.0.1",
    package_data={'cc': 
        find_data_files('cc', patterns=['*.xml', '*.m']) # .m is not required right now
        },
    ...
    install_requires=[
      ...
      "dm-acme[jax]", "dm-acme[envs]", "scikit-learn", "ray", "beartype", "equinox"
    ]
)
