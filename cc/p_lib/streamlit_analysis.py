...
prefix1 = "/home/simon/Documents/PYTHON/adv_chain_control/sweeps/sweep_28_10/"
prefix2 = prefix1 + "run_gridsearch_28_10_22/"

df = pd.read_pickle(prefix1 + "objective_2022-10-28_17-31-25.pkl")
default_options = [1, "v1", 2, 2, 0, 0, True, True, "random_steps", "EE"]
