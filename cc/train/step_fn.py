...
from ..types import BatchedTimeSeriesOfRef, Observation, PRNGKey, Reference
...
def step_fn_model(
    ...
    @eqx.filter_jit
    def _step_fn(
        model: AbstractModel, opt_state, minibatch_state: MiniBatchState
    ) -> Tuple[
        AbstractModel, Any, MiniBatchState, Union[ModelTrainTestLoss, ModelTrainLoss]
    ]:
...
def step_fn_controller(
    ...
    def grad_loss_fn_controller(
        controller: AbstractController, refss: BatchedTimeSeriesOfRef, key: PRNGKey
    ):
