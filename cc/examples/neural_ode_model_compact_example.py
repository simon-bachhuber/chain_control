...
def make_neural_ode_model(
    ...
    class NeuralOdeModel(AbstractModel):
        f: eqx.Module
        g: eqx.Module
        ...
        def step(self, u):  # u has shape identical to `toy_input`
            ...
            return (
                NeuralOdeModel(self.f, self.g, state_next, self.init_state),
                y_next,
        ...
        def y0(self):
            return postprocess_fn(self.g(batch_concat((self.init_state,), 0)))

    return NeuralOdeModel(f_init, g_init, init_state, init_state)
